    ...
    <section className="px-6 py-16 bg-white relative z-10 -mt-8 rounded-t-[2.5rem] md:rounded-none md:bg-transparent md:py-0 md:-mt-16">
        <div ref={gridRef} className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6">
            {benefits.map((item, idx) => (
                <div key={idx} className="reveal-item bg-white p-8 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:border-indigo-100 hover:-translate-y-1 transition-all group h-full">
