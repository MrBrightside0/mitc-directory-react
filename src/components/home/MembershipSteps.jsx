        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="bg-slate-800 p-6 border border-slate-700">
                    <div className="w-10 h-10 bg-indigo-600 flex items-center justify-center font-bold mb-4">1</div>
                ...
                <div className="bg-slate-800 p-6 border border-slate-700">
                    <div className="w-10 h-10 bg-indigo-600 flex items-center justify-center font-bold mb-4">2</div>
                ...
                <div className="bg-slate-800 p-6 border border-slate-700">
                    <div className="w-10 h-10 bg-indigo-600 flex items-center justify-center font-bold mb-4">3</div>
                ...
                <div className="bg-slate-800 p-6 border border-slate-700">
                    <div className="w-10 h-10 bg-indigo-600 flex items-center justify-center font-bold mb-4">4</div>
